...
const stripePromise = loadStripe(
  "pk_test_51M6KutGa2OWjGeD9GN2rYmNuaw4pUQG25cHLUWCrZYi6HheR12Rejng6u2zd8TGByKJwqprt6UWpiChX40WbaYKz0076e7UyIK",
);

const CheckoutForm = ({ amount, bookingId, onSuccess }: any) => {
  ...
  useEffect(() => {
    if (bookingResponse && bookingResponse.data) {
      const unpaid = bookingResponse.data.filter(
        (booking: any) => !booking.paymentStatus,
      );
